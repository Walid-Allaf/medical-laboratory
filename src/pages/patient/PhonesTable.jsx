...
const PhonesTable = ({ phones, patientId, getDetails }) => {
          ...
          <TableBody>
            {phones.length > 0 ? (
              phones?.map((phone, key) => {
                return (
                  <TableRow hover tabIndex={-1} key={phone.patientId}>
                    ...
                    <TableCell>
                      ...
                      >
                        ...
                        <Button
                          variant="contained"
                          color="error"
                          onClick={() => handleDelete(phone.patientPhoneId)}
                        >
                          حذف
                        </Button>
                      </Box>
